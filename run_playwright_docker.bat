...
echo    docker compose exec playwright_tests pytest -m login
echo    docker compose exec playwright_tests pytest -m login --browser chromium --headed -v --html=reports/report.html --self-contained-html
echo.
